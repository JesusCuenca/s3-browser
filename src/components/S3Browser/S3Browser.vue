...
import S3ItemListHeader from './S3ItemListHeader';
...
export default mixins(DragNDropEvents, Sorting).extend({
  name: 's3-browser',

  components: {
    's3-browser-item-object': S3ItemObject,
    's3-browser-item-folder': S3ItemFolder,
    's3-browser-item-list-header': S3ItemListHeader,
  },
